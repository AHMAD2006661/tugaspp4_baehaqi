...
class AppHistory {
  static final List<Map<String, dynamic>> items = [
    ...
    {
      'title': 'Top Up Dompet',
      'subtitle': 'Kemarin · 19.00',
      'amount': 500000,  
    },
    {
      'title': 'Pulsa Telpon',
      'subtitle': 'Kemarin · 08.35',
      'amount': -30000,
    },
    {
...
class _SendMoneyViewState extends State<_SendMoneyView> {
  ...
  String _mode = 'Kontak Tersimpan'; // Kontak Tersimpan / Nomor Baru / Rekening Bank
  String _bank = 'BCA';
  ...
  final List<Map<String, String>> _savedContacts = const [
    {
      'name': 'Budi Santoso',
      'detail': 'Budi Santoso · 0812 1234 5678',
    },
    {
      'name': 'Ana Rahma',
      'detail': 'Ana Rahma · 0857 2345 8899',
    },
  ];
  ...
  Future<void> _doSend() async {
    ...
    final intNominal = int.tryParse(nominal.replaceAll('.', '').replaceAll(',', '')) ?? 0;

    final tujuan = () {
      if (_mode == 'Nomor Baru') return _phoneCtrl.text.trim();
      if (_mode == 'Rekening Bank') return '$_bank · ${_accountCtrl.text.trim()}';
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    _confirmRow('Catatan', catatan),
                    const SizedBox(height: 10),
                    _confirmRow('Simpan sebagai favorit', _saveAsFavorite ? 'Ya' : 'Tidak'),
                ...
                children: [
                    ...
                    children: [
                      ChoiceChip(
                        ...
                        labelStyle: TextStyle(
                          color: _mode == 'Kontak Tersimpan' ? Colors.white : Colors.black87,
                        ),
                        onSelected: (_) => setState(() => _mode = 'Kontak Tersimpan'),
                      ),
                      ChoiceChip(
                        ...
                        selectedColor: kPrimaryColor,
                        labelStyle: TextStyle(
                          color: _mode == 'Nomor Baru' ? Colors.white : Colors.black87,
                        ),
                      ...
                      ChoiceChip(
                        ...
                        selectedColor: kPrimaryColor,
                        labelStyle: TextStyle(
                          color: _mode == 'Rekening Bank' ? Colors.white : Colors.black87,
                        ),
                        onSelected: (_) => setState(() => _mode = 'Rekening Bank'),
                      ),
                    ],
                  ),
                  const SizedBox(height: 10),
                  if (_mode == 'Kontak Tersimpan') ...[
                    ...
                    TextField(
                      ...
                      decoration: _inputDecoration('Masukkan nomor HP / ID akun'),
                    ),
                  ] else ...[
                    const Text(
                      'Bank tujuan',
                  ...
                  Row(
                    children: [
                      ...
                      const Expanded(
                        child: Text('Simpan tujuan ini sebagai penerima favorit'),
                      ),
                    ],
                  ),
                  const Spacer(),
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                ...
                if (!_viaLink && _fromCtrl.text.trim().isEmpty) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Nama/nomor kontak belum diisi.')),
                  );
                  return;
                }
                ScaffoldMessenger.of(context).showSnackBar(
              ...
              ListTile(
                ...
                onTap: () async {
                  ...
                  final res = await showDialog<int>(
                    ...
                    builder: (dCtx) => AlertDialog(
                      ...
                      content: TextField(
                        ...
                        keyboardType: TextInputType.number,
                        decoration: _inputDecoration('Limit per transaksi (Rp)'),
                      ),
                      actions: [
                        TextButton(
                  ...
                  if (res != null) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Limit transaksi diperbarui.')),
                    );
                  }
                },
              ),
    ...
    final List<Map<String, String>> methods = [
      {
        ...
        'desc': 'Gunakan fitur ini untuk tarik tunai di ATM tanpa kartu fisik. '
...
class _MobileTopupViewState extends State<_MobileTopupView> {
  ...
  String _detectOperator(String phone) {
    ...
    if (clean.startsWith('0812') || clean.startsWith('0813') || clean.startsWith('0821')) {
      return 'Telkomsel';
    } else if (clean.startsWith('0857') || clean.startsWith('0856') || clean.startsWith('0858')) {
      return 'Indosat';
    } else if (clean.startsWith('0817') || clean.startsWith('0818') || clean.startsWith('0819')) {
      return 'XL';
  ...
  bool get _canPay {
    final phoneValid = _phoneCtrl.text.replaceAll(RegExp(r'\D'), '').length >= 10;
    return phoneValid;
  }
  ...
  Future<void> _showConfirmSheet() async {
    ...
    if (isPulsa) {
      price = _pricePulsaForOperator(operator, _pulsaAmounts[_selectedPulsaIndex]);
          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  height: 230,
                  child: isPulsa ? _buildPulsaGrid(op) : _buildDataList(packages),
                ),
                const SizedBox(height: 8),
                Container(
                  width: double.infinity,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 6),
                      _summaryRow(
                          'Nomor', _phoneCtrl.text.isEmpty ? '-' : _phoneCtrl.text),
              ...
              children: [
                for (int i = 0; i < _pulsaAmounts.length; i++)
                  ChoiceChip(
                    ...
                    labelStyle: TextStyle(
                      color:
                          _selectedPulsaIndex == i ? Colors.white : Colors.black87,
                    ),
            ...
            itemBuilder: (ctx, i) {
              ...
              return GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  padding: const EdgeInsets.all(12),
                  decoration: BoxDecoration(
                    color: selected ? kPrimaryColor.withOpacity(0.07) : Colors.white,
                    borderRadius: BorderRadius.circular(14),
                    border: Border.all(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _summaryRow(
                  'ID Pelanggan',
                  widget.idCtrl.text.trim().isEmpty ? '-' : widget.idCtrl.text.trim(),
                ),
                const SizedBox(height: 4),
    ...
    return Stack(
      children: [
        ListView.builder(
          ...
          itemBuilder: (ctx, i) {
            final g = _goals[i];
            final double progress = (g['current'] as int) / (g['target'] as int);
                    ...
                    child: Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontWeight: FontWeight.w500,
                          color:
                              _tab == 0 ? Colors.black : Colors.grey[600],
                        ),
                      ),
                    ),
                  ),
                    ...
                    child: Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontWeight: FontWeight.w500,
                          color:
                              _tab == 1 ? Colors.black : Colors.grey[600],
                        ),
                      ),
                    ),
                  ),
                        ...
                        TextButton(
                          onPressed: () {
                            ...
                            if (newName.isNotEmpty) {
                              setState(() {
                                final idx =
                                    _recipients.indexWhere((e) => e['account'] == r['account']);
                                if (idx != -1) {
